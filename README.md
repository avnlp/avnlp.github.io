...
- Trained a Retrieval Evaluator for Corrective RAG [(https://arxiv.org/abs/2401.15884)](https://arxiv.org/abs/2401.15884) on the dataset provided by the authors. The T5 model is trained classify documents as 'Correct', 'Ambiguous', or 'Incorrect' based on the input question and retrieved documents.
